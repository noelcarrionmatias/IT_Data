...
select hospital_id, count(distinct(paciente_id)) as 'Total pacientes por hospital'
from hospitales.pacientes
...
select comunidad_autonoma, provincia, round(avg(indice_satisfaccion),2) as 'Indice de satisfacción media'
